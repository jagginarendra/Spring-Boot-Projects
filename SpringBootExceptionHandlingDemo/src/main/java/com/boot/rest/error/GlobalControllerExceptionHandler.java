...
public class GlobalControllerExceptionHandler {
	...
	public ApiErrorResponse constraintViolationExceptio(ConstraintViolationException ex) {
	...
	public ApiErrorResponse unknownException(Exception ex) {
		...
		System.out.println("unknown exception handler");
